...
class NeuralNetwork(object):
    def __init__(self, input_nodes, hidden_nodes, output_nodes, learning_rate):
        ...
        # as shown below.
        self.activation_function = lambda x : np.exp(x)/(1.0+np.exp(x))  # Replace 0 with your sigmoid calculation.
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        delta_weights_h_o += ( hidden_outputs*output_error_term).reshape(self.hidden_nodes,self.output_nodes)
